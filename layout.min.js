...
10),D="mozilla"==h,w=window.requestAnimationFrame,m=window.cancelRequestAnimationFrame,h=["ms","moz","webkit","o"],k=0;k<h.length&&!w;++k)w=window[h[k]+"RequestAnimationFrame"],m=window[h[k]+"CancelRequestAnimationFrame"];if(w)var n=function(a){w(a)};n||(n=window.setTimeout);m||(m=window.clearTimeout);var F=n,G=m;g.config=function(a,b){switch(a){case "fps":y=b;break;case "vsync":z=b;break;case "default":n=F;m=G;break;case "fallback":n=window.setTimeout,m=window.clearTimeout}A=z?function(){g()}:E};
g.schedule=function(a,b){if(b||!u)u&&m(u),u=n(function(){g();u=null},a||0)};g.defer=function(a,b){"undefined"==typeof b&&(b=1E3/y);return n(a,b)};g.undefer=function(a){return m(a)};g.add=function(a){l||(l=f("BODY:first"));a.layout=f.extend({children:[]},a.layout);a.layout&&a.layout.parent?(a.layout.parent.layout.children||(a.layout.parent.layout.children=[]),a.layout.parent.layout.children.push(a)):q=q.add(f(a));a=f(a);0==r.length&&0<a.length&&f(window).bind("resize",A);r=r.add(a)};g.del=function(a){a=
f(a);r=r.not(a);0==r.length&&f(window).unbind("resize",A)};var B=!1,E=function(){if(B)return!1;B=n(function(){g();B=!1},1E3/y)},A=z?function(){g()}:E;"undefined"==typeof OCBNET&&(OCBNET={});OCBNET.Layout=g})(jQuery);
